  ...
  <div class="main_content">
    ...
    <div class="dash_overview">
        ...
        <div class="tableau_actions">
          <button type="submit" name="action" value="ajouter" class="tab_btn btn-add" data-type="report" data-role="veto">Ajouter</button>
          <div>
            <button type="submit" name="action" value="modifier" class="tab_btn btn-edit" data-type="modreport" data-role="veto">Modifier</button>
            <button type="submit" name="action" value="supprimer" class="tab_btn btn-delete" data-type="delreport" data-role="veto">Supprimer</button>
          </div>
        </div>

      

      <form action="/veto/journal/filtrer" method="GET" class="filter-form">
