  ...
  <div class="main_content">
    ...
    <div id="modalAddService" class="modal">
      <div class="modal_container">
        ...
        <form id="formAddService" data-role="staff">
    ...
    <div id="modalModifyService" class="modal">
      <div class="modal_container">
          ...
          <form id="formModifyService" data-role="staff">
            <div class="form-group">
    ...
    <div id="modalAddImage" class="modal">
      <div class="modal_petit">
        ...
        <form id="formAddImage" method="POST" enctype="multipart/form-data" data-role="staff">
          <div class="form-group">
            <label for="file_id_service">Selectionner un service :</label>
            <select type="hidden" name="file_id_service" id="file_id_service" required>
              <?php foreach ($services as $service): ?>
