<div class="dash_container">
  ...
  <div class="main_content">
    ...
    <div class="dash_overview">
      <form action="/admin/comptes" method="POST">
        <div class="tableau_actions">
          <button type="button" class="tab_btn btn-add" id="toggleFormBtn">Ajouter un compte</button>
          <div>
    ...
    <div id="modalModifierUser" class="modal">
      <div class="modal_container">
        <div class="model_title">
          <span class="close">&times;</span>
          <h2>Modifier un utilisateur</h2>
        </div>
        <form id="formModifierUser">
          ...
          <button type="submit" id="btnSubmitModifierUser">Modifier</button>
        </form>
      </div>
    </div>
  </div>
